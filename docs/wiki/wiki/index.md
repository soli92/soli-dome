...
> Mappa della conoscenza del progetto `soli-dome`, derivata dai documenti di contesto del repository.

## Repository snapshot

Riassunto operativo per Soli Dome (portale app / home links). Dettaglio: README.md. Stato file: git status. Memoria sviluppo AIassisted: AILOG.md.
